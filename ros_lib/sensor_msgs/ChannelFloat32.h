...
namespace sensor_msgs
{
  ...
  class ChannelFloat32 : public ros::Msg
  {
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      u_st_values.base = 0;
      u_st_values.base |= ((unsigned long) (*(inbuffer + offset + 0))) << (8 * 0);
      u_st_values.base |= ((unsigned long) (*(inbuffer + offset + 1))) << (8 * 1);
      u_st_values.base |= ((unsigned long) (*(inbuffer + offset + 2))) << (8 * 2);
      u_st_values.base |= ((unsigned long) (*(inbuffer + offset + 3))) << (8 * 3);
